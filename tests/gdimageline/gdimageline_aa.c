...
int gen_image(const char *filename, int idx, int reverse_x, int width,
			  int height, int bgd) {
...
int main() {
	...
	error |=
		gen_image("gdimageline/gdimageline_aa_a_0_exp.png", 0, 1, 10, 100, 1);

	error |=
		gen_image("gdimageline/gdimageline_aa_a_1_exp.png", 1, 1, 10, 100, 2);

	error |=
		gen_image("gdimageline/gdimageline_aa_b_0_exp.png", 2, -1, 10, 100, 1);
	error |=
		gen_image("gdimageline/gdimageline_aa_b_1_exp.png", 1, -1, 10, 100, 2);

	error |=
		gen_image("gdimageline/gdimageline_aa_c_0_exp.png", 0, 1, 100, 10, 1);
	error |=
		gen_image("gdimageline/gdimageline_aa_c_1_exp.png", 1, 1, 100, 10, 2);

	error |=
		gen_image("gdimageline/gdimageline_aa_d_0_exp.png", 2, -1, 100, 10, 1);
	error |=
		gen_image("gdimageline/gdimageline_aa_d_1_exp.png", 1, -1, 100, 10, 2);
